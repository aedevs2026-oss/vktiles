...
from .constants import MAX_ASPECT_RATIO, MIN_HERO_AREA, MIN_TILE_AREA, MIN_TILE_DIM
...
def is_tile_image(pixel_w: int, pixel_h: int, min_area: int = MIN_TILE_AREA) -> bool:
